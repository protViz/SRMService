...
resStr <-quantable::volcanoplot(res.eb$logFC, res.eb$q.mod, foldchangethresh = grp2$qfoldchange , pthresh = grp2$qvalue ,labels=rownames(res.eb),xlab = paste("log2(",grp2$getConditions()$condition,"/",grp2$getConditions()$reference,")"))
...
res.eb <-grp2$getPValues()
resStr <- quantable::volcanoplot(res.eb$logFC, res.eb$p.mod, foldchangethresh = grp2$pfoldchange , pthresh = grp2$pvalue ,labels=rownames(res.eb), xlab = paste("log2(",grp2$getConditions()$condition,"/",grp2$getConditions()$reference,")"))
```
...
resRel <- quantable::volcanoplot(res.eb$logFC, res.eb$p.ord, foldchangethresh = grp2$pfoldchange , pthresh = grp2$pvalue ,labels=rownames(res.eb),xlab = paste("log2(",grp2$getConditions()$condition,"/",grp2$getConditions()$reference,")"))
