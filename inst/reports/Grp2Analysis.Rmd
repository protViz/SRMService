...
cond1 <- grp2$getConditionData(grp2$conditions[1],top= round(nrow(grp2$proteinIntensity)/20))
cond2 <- grp2$getConditionData(grp2$conditions[2],top= round(nrow(grp2$proteinIntensity)/20))
...
If you are going to use results produced by the scripts please do cite the SRMSerivce R package by providing the following URL  www.github.com/protViz/SRMService by W.E. Wolski, J. Grossmann, C. Panse
