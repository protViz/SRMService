...
```{r fig.width=10, fig.height=8, dpi=300, fig.cap="VolcanoPlot for normalized and imputed matrix with moderated q Values."}
res.eb <-grp2$getPValues()
...
```{r heatmapOfpValues, fig.width=10, fig.height=8, dpi=300, fig.cap="Histogram of all raw p values"}
hist(res.eb$p.ord, col="blue")
```
