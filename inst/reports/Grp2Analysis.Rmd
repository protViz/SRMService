...
## Adjusted p-values (q-values) (normal t-test)
...
resRel <- quantable::volcanoplot(res.eb$log2FC, res.eb$q.ord, foldchangethresh = grp2$qfoldchange , pthresh = grp2$qvalue ,labels=rownames(res.eb),xlab = fcname)
...
```{r histOfpValues, fig.width=10, fig.height=8, dpi=300, fig.cap="Histogram of moderated p values", include=FALSE}
