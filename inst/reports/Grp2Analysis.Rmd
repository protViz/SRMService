...
The input matrix has the following structure (Figure 1).
...
The scaling factors are visualized in Figure \@ref(fig:scaling). It shows with what factor the individually samples
...
In Figure 8 we show how samples are clustering depending on their protein expression profiles.
