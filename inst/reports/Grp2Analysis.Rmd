...
Here we show the result of a two group analysis for the normalized matrix using bioconductor limma. 
...
```{r heatmapOfpValues, fig.width=10, fig.height=8, dpi=300, fig.cap="Histogram of moderated p values"}
hist(res.eb$p.mod, breaks=40, xlab="", main="")
```
