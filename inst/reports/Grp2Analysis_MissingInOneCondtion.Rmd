...
Some proteins were quantified only in one condition. In such a case no p-values or fold change can be computed. Nevertheless, proteins with relatively high intensity in one condition but not present in the other condition can have biological relevance. Figure \@ref(fig:plotPresentInOnlyOneCondition) shows how many protein were not quantified in a condition. The Figure \@ref(fig:barplotIntensitiesSingle) visualizes the most intensive proteins not quantified in the other condition. Finally, in the Volcano plot Figure \@ref(fig:pseudoVolcanoplot) we show all the proteins quantified including those identified only in one of the samples (green). The reported fold change is computed by subtracting from the quantification value the average of the 10% smallest protein averages of the other condition. The p-value for those proteins was set to 0.
