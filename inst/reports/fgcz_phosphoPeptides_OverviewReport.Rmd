...
myValues <- c(myPhosphoSTY, LocProbThreshold, "0.01", maxNAsForComparison)
...
ggseqlogo(as.vector(myMat_good_singlyPhos$SeqWindow[bool_ProperLength]), seq_type='aa') + ggtitle("All phospho peptides (singly phos, localization probability OK)")
```

```{r Logo_S, fig.width=8,fig.height=4,dpi=300,fig.cap="Sequence logo for singly phosphorylated Serines"}
try(ggseqlogo(aln_S, seq_type='aa') +  ggtitle("All Serine phospho peptides"))
```

```{r Logo_T, fig.width=8,fig.height=4,dpi=300,fig.cap="Sequence logo for singly phosphorylated Serines"}
try(ggseqlogo(aln_T, seq_type='aa') +  ggtitle("All Threonine phospho peptides"))
```

```{r Logo_Y, fig.width=8,fig.height=4,dpi=300,fig.cap="Sequence logo for singly phosphorylated Serines"}
try(ggseqlogo(aln_Y, seq_type='aa') +  ggtitle("All Tyrosine phospho peptides"))
```
