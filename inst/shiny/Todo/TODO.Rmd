...
Definitely worth a close look. Uses tidy concepts.

[DEP Vignette](https://www.bioconductor.org/packages/devel/bioc/vignettes/DEP/inst/doc/DEP.html)
[DEP Project site](https://bioconductor.org/packages/release/bioc/html/DEP.html)

Includes Enrichment analysis based on:

[EnrichR](http://amp.pharm.mssm.edu/Enrichr/)
which can be accessed from R with:
[EnbrichR](https://cran.r-project.org/web/packages/enrichR/index.html)
...
Not necessarily the best, example how to integrate different software and benchmark results.
...
Protein intensity modelling using aggregation:
$$
Protein_{aggr} = p^1_a+p^2_a + \dots + p^n_a
$$
...
$f$ - could be median, mean, robust mean etc (See ROPECA).
...
[Peptide-level Robust Ridge Regression Improves Estimation, Sensitivity, and Specificity in Data-dependent Quantitative Label-free Shotgun Proteomics](http://www.mcponline.org/content/15/2/657.long)
...
[Bayesian Methodology for Missing Data, Model Selection and
Hierarchical Spatial Models with Application to Ecological Data](https://vtechworks.lib.vt.edu/bitstream/handle/10919/26141/Dissertation.pdf)

[STAN for linear mixed models]
(http://www.maths.bath.ac.uk/~jjf23/stan/)

[Doing Bayesian Data Analysis, Second Edition: A Tutorial with R, JAGS, and Stan 2nd Edition](https://sites.google.com/site/doingbayesiandataanalysis/)
